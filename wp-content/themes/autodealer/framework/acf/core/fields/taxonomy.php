...
class acf_taxonomy_field_walker extends Walker
{
	...
	function __construct( $field )
	{
		...
		$term_id = isset( $_GET['pid'] ) ? $_GET['pid'] : false;

		$this->selected_terms = wp_get_post_terms( $term_id , $this->field['taxonomy'], array("fields" => "ids") );
	...
	{	
		...
		// vars
		$selected = in_array( $term->term_id, $this->selected_terms );
