...
class FRONTEND_EDIT_PROFILE{
	...
	{	
	    load_plugin_textdomain( 'tdp-profile-edit', false, dirname( plugin_basename( __FILE__ ) ) . '/langs/' );
	}
	...
	function form_script(){
		...
		wp_enqueue_script('fep-forms-passmeter',$passmeter, array('jquery'),'0.3', true);
		wp_enqueue_script('fep-forms-script',$src,array('fep-forms-passmeter'),'1.0', true);
	}
			...
			<div class="tdp-inner tdp-login-wrapper">
				...
				<div class="tdp-main">
						...
						<div class="fep">
							...
							<form id="your-profile" action="<?php echo get_permalink(); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="tdp-field tdp-seperator tdp-edit tdp-edit-show first-sep"><?php _e("Name", "tdp-profile-edit");?></div>

								<table class="form-table">
									<tr>
										<th><label for="user_login"><?php _e('Username','tdp-profile-edit'); ?></label></th>
										<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr($profileuser->user_login); ?>" disabled="disabled" class="regular-text" /><br /><em><span class="description"><?php _e('Usernames cannot be changed.','tdp-profile-edit'); ?></span></em></td>
									</tr>
									<tr>
								...
								<table class="form-table fields-lenght" id="fields-lenght">
									<tr>
										<th><label for="email"><?php _e('E-mail','tdp-profile-edit'); ?> <span class="description"><?php _e('(required)','tdp-profile-edit'); ?></span></label></th>
									...
									<?php do_action( 'custom_acf' ); ?>


									<p class="submit">
										<input type="hidden" name="action" value="update" />
										<input type="hidden" name="profile_submit" id="profile_submit" value="true" />
										<input type="hidden" name="redirect_submit" id="redirect_submit" value="<?php the_permalink();?>" />
										<input type="hidden" name="user_id" id="user_id" value="<?php echo esc_attr($user_id); ?>" />
										<input type="submit" class="button-primary" id="update-profile-button" value="<?php _e('Update Profile','tdp-profile-edit'); ?>" name="submit" />
									</p>
