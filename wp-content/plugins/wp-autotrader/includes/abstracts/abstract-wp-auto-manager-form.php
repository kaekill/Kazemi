...
/**
 * Abstract WP_Auto_Manager_Form class.
 *
 * @abstract
 */
abstract class WP_Auto_Manager_Form {
	...
	public static function show_errors() {
		foreach ( self::$errors as $error )
			echo '<div class="auto-manager-error"> <div class="attention"><i class="icon-attention"></i></div> ' . $error . '<div class="clear"></div></div>';
	}
