...
if( $blog_layout == 'Classic Style' || $blog_layout == '' || is_single()) { ?>
	...
	<blockquote class="blog-quote"><i class="icon-quote-left"></i> <?php the_field('insert_quote');?> <i class="icon-quote-right"></i><span class="quote-author"><?php the_field('quote_author');?></span></blockquote>	 
