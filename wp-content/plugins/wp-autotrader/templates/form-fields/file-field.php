<?php if ( ! empty( $field['value'] ) ) : ?>
	<div class="uploaded_image">
		<img src="<?php echo $field['value']; ?>" /> <?php echo '<code>' . basename( $field['value'] ) . '</code> ' . __( 'or', 'auto_manager' ) . '&hellip;'; ?>
...
<small class="description">
	<?php printf( __( 'Max. file size: %s. Allowed images: jpg, gif, png.', 'auto_manager' ), size_format( wp_max_upload_size() ) ); ?>
</small>